      ...
      >
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h3 id="delete-template-title" className="text-base font-bold text-slate-950">
              Delete WhatsApp Template?
            </h3>
            <p id="delete-template-description" className="mt-1.5 text-sm text-slate-600">
              Are you sure you want to delete <span className="font-semibold text-slate-900">&ldquo;{title || "Untitled Template"}&rdquo;</span>? This will remove it from quick compose options.
            </p>
          </div>
        </div>
