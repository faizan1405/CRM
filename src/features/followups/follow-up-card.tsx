  ...
  return (
    ...
    >
      ...
      {statusInfo !== "Completed" && statusInfo !== "Cancelled" && (
        <div className="mt-2.5 flex items-center justify-between gap-1.5 border-t border-slate-100 pt-2.5" onClick={(e) => e.stopPropagation()}>
          <button
            type="button"
            onClick={(e) => { e.preventDefault(); onCall(); }}
            className="flex-1 inline-flex min-h-[44px] items-center justify-center gap-1.5 rounded-xl bg-blue-50 text-blue-700 text-[13px] font-bold hover:bg-blue-100 active:bg-blue-200 transition-colors"
          ...
          <button
            ...
            className="flex-1 inline-flex min-h-[44px] items-center justify-center gap-1.5 rounded-xl bg-[#25d366]/10 text-[#20bd5a] text-[13px] font-bold hover:bg-[#25d366]/20 active:bg-[#25d366]/30 transition-colors"
          ...
          <button
            ...
            className="flex-1 inline-flex min-h-[44px] items-center justify-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 text-[13px] font-bold text-emerald-700 hover:bg-emerald-100 active:bg-emerald-200 disabled:opacity-50 transition-colors shadow-sm"
          ...
          <button
            type="button"
            onClick={(e) => { e.preventDefault(); onReschedule(); }}
            className="inline-flex min-h-[44px] w-11 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 active:bg-slate-100 transition-colors shadow-sm"
            aria-label={`Reschedule`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/><path d="M17.5 17.5 16 16.3V14"/><circle cx="16" cy="16" r="6"/></svg>
          </button>
        </div>
      )}
      ...
      {statusInfo === "Completed" && (
        <div className="mt-2.5 border-t border-slate-100 pt-2.5">
          <button
            ...
            className="inline-flex min-h-[44px] w-full items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white text-[13px] font-bold text-slate-700 hover:bg-slate-50 active:bg-slate-100 transition-colors shadow-sm"
          >
            Open Lead
          </button>
        </div>
